...
* Button Event: /nds/button,ss (button, event) where button is one of UP DOWN LEFT RIGHT R L X Y A B START and event is one of UP DOWN. (I'll reserve the SELECT button to things like mode changes, IP configuration etc.) (TOP PRIORITY)
